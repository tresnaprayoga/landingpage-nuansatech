const pricingPlans = [
  {
    ...
    price: 'IDR 500.000',
    duration:
      ' ✔️ Gratis Hosting & Domain(xyz, .my.id), \n ✔️Template Web statis \n  ✔️update content max 5 kali (via tim kami) \n ✔️Fitur: Formulir /WhatsApp, Google Map ✔️Desain responsif (Smart Phone & Desktop ) \n✔️ Revisi: 2x revisi minor (teks/gambar) \n✔️Gratis Copywriting Konten \n ✔️Integrasi Medsos  \n✔️Waktu Pengerjaan: 2 Hari kerja',
  },
  {
    name: '2 Tahun Berlangganan',
    price: 'IDR 1000.000',
    duration:
      ' ✔️ Gratis Hosting & Domain (xyz, .my.id), \n ✔️Template Web statis \n  ✔️update content max 10 kali (via tim kami) \n ✔️ Fitur: Formulir /WhatsApp, Google Map ✔️Desain responsif (Smart Phone & Desktop) \n✔️ Revisi: 2x revisi minor (teks/gambar) \n✔️Gratis Copywriting Konten \n ✔️Integrasi Medsos \n✔️Waktu Pengerjaan: 2 Hari kerja',
  },
  {
